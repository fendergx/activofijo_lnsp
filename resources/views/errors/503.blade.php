                        ...
                        <div class="error-content">
                            <div class="card mb-0">
                                <div class="card-body text-center">
                                    ...
                                    <h4 class="mt-4"><i class="fa fa-thumbs-down text-danger"></i>Sistema en mantenimiento</h4>
                                    <p>El sistema no está disponible temporalmente <br>Se habilitará lo más pronto posible.</p>
