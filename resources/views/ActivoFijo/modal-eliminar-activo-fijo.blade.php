<div class="modal fade" id="modal-eliminar-activo-fijo">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-header col-sm-12 justify-content-center">
				<h5 class="modal-title" style="text-align: center;"><strong>Eliminar activo fijo</strong></h5>
			</div>
			<!-- Cuerpo modal-->
			<div class="modal-body">
				<div id="modal-body-eliminar">
					<h5 class="text-center">¿Está seguro/a de eliminar el activo fijo?<br></h5>
				</div>
