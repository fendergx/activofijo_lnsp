                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('usuario.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nombre_usuario" type="text" class="form-control @error('name') is-invalid @enderror" name="nombre_usuario" value="{{ old('name') }}" required autocomplete="name" autofocus>
